...
class PrizesControllerTest < ActionController::TestCase
  ...
  test "should create prize" do
    assert_difference('Prize.count') do
      post :create, :prize => { :amount_cents => @prize.amount_cents, :amount_currency => @prize.amount_currency, :name => @prize.name }
    end
  ...
  test "should update prize" do
    put :update, :id => @prize, :prize => { :amount_cents => @prize.amount_cents, :amount_currency => @prize.amount_currency, :name => @prize.name }
    assert_redirected_to prize_path(assigns(:prize))
  end
