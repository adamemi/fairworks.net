...
role :web,              "66.37.67.153" # location of the web server
role :app,              "66.37.67.153" # may be the same as your 'Web' server
role :db,               "66.37.67.153", :primary => true # where Rails migrations will run, NOT the location of the db
